...
function checkPageSection() {
  ...
  _.each(document.querySelectorAll('#top-menu li'), function(element) {
    element.className = '';
  });

  if (sectionIndex > -1)
    document.querySelectorAll('#top-menu li')[sectionIndex].className = 'selected';
}
...
var light = new FSS.Light('#66002d', '#FF0043');
var geometry = new FSS.Plane(900, 300, 9, 3);
